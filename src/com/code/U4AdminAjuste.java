...
public class U4AdminAjuste extends javax.swing.JFrame {
    ...
    public U4AdminAjuste() {
        ...
        this.setTitle("Sicovp Login Administración > Opciones > Ajustes");
        //--------------------------------------------------------------------------------------------------------| 
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++|  
    ...
    public void metRegistrarUsuario() {
        ...
        try {
            ...
            String remitente = "parnatura.loby@outlook.com"; // o "tu_correo@hotmail.com"
            String contraseña = "raaemfqsbxtkcenf";
            String destinatario = registroCorreoElectronico;
            String asunto = "Sicovp Nuevo Usuario";
            String mensaje = "EDIFICIO PARQUE NATURA \n \n [Ser Seguridad - Parque Natura] le informa que su cuenta en el software (Sicovp) ha sido creado exitosamente, esta sera manejada y administrada por el administrador a cargo en el momento del servicio, para realizar modificacion o eliminacion de su cuenta por favor contacte con la Administracion del edificio Parque Natura. \n \n \n \n Gracias, \n \n Equipo Ser Seguridad.- Equipo Parque Natura. \n \nSoftware creado y desarrollado por Luis Eduardo Morales.\nTelefono: 3202187288.\nCorreo:luiseduardo192@hotmail.com ";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++|
    ...
    public void actualizarUsuario() {
        ...
        try {
            ...
            String asunto = "Sicovp Usuario Modificado";
            String mensaje = "EDIFICIO PARQUE NATURA \n \n[Ser Seguridad - Parque Natura] le informa que su cuenta en el software (Sicovp) ha sido modificada exitosamente. \n \nGracias, \n \n Equipo Ser Seguridad.- Equipo Parque Natura.\n \nSoftware creado y desarrollado por Luis Eduardo Morales.\nTelefono: 3202187288.\nCorreo:luiseduardo192@hotmail.com ";
            enviarCorreo(proveedor, remitente, contraseña, destinatario, asunto, mensaje);
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++| 
    public void eliminarUsuario() {
        ...
        try {
            ...
            String asunto = "Sicovp Usuario Eliminado";
            String mensaje = "EDIFICIO PARQUE NATURA \n \n[Ser Seguridad - Parque Natura] le informa que su cuenta en el software (Sicovp) ha sido eliminada exitosamente. \n \nGracias, \n \nEquipo Ser Seguridad.- Equipo Parque Natura. \n \nSoftware creado y desarrollado por Luis Eduardo Morales.\nTelefono: 3202187288.\nCorreo:luiseduardo192@hotmail.com ";
            enviarCorreo(proveedor, remitente, contraseña, destinatario, asunto, mensaje);
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++|
    ...
    // Este método se encarga de cerrar el JFrame actual, y mostrar otro
    private void metSetU2LoginAdmon() {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++|
    ...
    private void initComponents() {
        ...
        btnU4Regresar = new javax.swing.JButton();
        jCPanel1 = new com.bolivia.panel.JCPanel();
        txt_u4_admin_ajuste_nombre_vigilante = new javax.swing.JLabel();
        ...
        btbU4Limpiar = new javax.swing.JButton();
        ...
        btnU4Regresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/iconos/ico_home_x24.png"))); // NOI18N
        btnU4Regresar.setToolTipText("Regresar");
        btnU4Regresar.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/iconos/ico_home_x20.png"))); // NOI18N
        btnU4Regresar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/iconos/ico_home_x22.png"))); // NOI18N
        btnU4Regresar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnU4RegresarMouseClicked(evt);
            }
        });
        ...
        txt_u4_admin_ajuste_nombre_vigilante.setFont(new java.awt.Font("Calibri", 1, 15)); // NOI18N
        txt_u4_admin_ajuste_nombre_vigilante.setForeground(new java.awt.Color(255, 255, 255));
        txt_u4_admin_ajuste_nombre_vigilante.setText("v1_ajuste_txt_get_name_vigilante");
        ...
        jPanel_fondo_banerLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_fondo_banerLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_u4_admin_ajuste_nombre_vigilante)
                .addContainerGap())
        );
        jPanel_fondo_banerLayout.setVerticalGroup(
            jPanel_fondo_banerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jCPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
            .addComponent(txt_u4_admin_ajuste_nombre_vigilante, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(jPanel_fondo_banerLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel_fondo_banerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnU4Regresar, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btbU4Limpiar.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        btbU4Limpiar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/iconos/ico_clean_40px.png"))); // NOI18N
        btbU4Limpiar.setPreferredSize(new java.awt.Dimension(123, 38));
        btbU4Limpiar.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/iconos/ico_clean_32px.png"))); // NOI18N
        btbU4Limpiar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/iconos/ico_clean_37px.png"))); // NOI18N
        btbU4Limpiar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btbU4LimpiarMouseClicked(evt);
            }
        });
        btbU4Limpiar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btbU4LimpiarActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btbU4Limpiar, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(btbU4Limpiar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addComponent(jLabel_foto_perfil, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnU4RegresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnU4RegresarMouseClicked
        /*INVOCAR METODO PARA ENVIAR A U2LOGINADMON*/
        metSetU2LoginAdmon();

    }//GEN-LAST:event_btnU4RegresarMouseClicked
    ...
    private void txtU4NumeroCedulaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtU4NumeroCedulaKeyTyped
        ...
        javax.swing.text.AbstractDocument doc
                = (javax.swing.text.AbstractDocument) txtU4NumeroCedula.getDocument();
        doc.setDocumentFilter(new NumberOnlyFilter());
        /* ------------------------------------------------------------------------------------ */
        //Validador JtexField Cantidad de Caracteres deseados
        if (txtU4NumeroCedula.getText().length() == 10) {
            evt.consume();
        }
        /* ------------------------------------------------------------------------------------ */
    ...
    private void txtU4NombresKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtU4NombresKeyTyped
        ...
        javax.swing.text.AbstractDocument doc
                = (javax.swing.text.AbstractDocument) txtU4Nombres.getDocument();
        doc.setDocumentFilter(new LetterSpaceFilter());
        /* ------------------------------------------------------------------------------------ */
 /* ------------------------------------------------------------------------------------ */
        //Validador JtexField Cantidad de Caracteres deseados
        if (txtU4Nombres.getText().length() == 17) {
            evt.consume();
        }
        /* ------------------------------------------------------------------------------------ */
    ...
    private void txtU4ApellidosKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtU4ApellidosKeyTyped
        ...
        // Invocar LetterSpaceFilter
        javax.swing.text.AbstractDocument doc
                = (javax.swing.text.AbstractDocument) txtU4Apellidos.getDocument();
        doc.setDocumentFilter(new LetterSpaceFilter());
        /* ------------------------------------------------------------------------------------ */
        /* ------------------------------------------------------------------------------------ */
        //Validador JtexField Cantidad de Caracteres deseados
        if (txtU4Apellidos.getText().length() == 17) {
            evt.consume();
        }
        /* ------------------------------------------------------------------------------------ */
    ...
    private void txtU4CelularKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtU4CelularKeyTyped
        ...
        //Invocar NumberOnlyFilter
        javax.swing.text.AbstractDocument doc
                = (javax.swing.text.AbstractDocument) txtU4Celular.getDocument();
        doc.setDocumentFilter(new NumberOnlyFilter());
        /* ------------------------------------------------------------------------------------ */
        //Validador JtexField Cantidad de Caracteres deseados
        if (txtU4Celular.getText().length() == 10) {
            evt.consume();
        }
        /* ------------------------------------------------------------------------------------ */
    ...
    private void btbU4LimpiarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btbU4LimpiarMouseClicked
        // Establecer los campos en blanco
        txtU4NumeroCedula.setText("");
        txtU4Nombres.setText("");
        txtU4Apellidos.setText("");
        txtU4Correo.setText("");
        txtU4Celular.setText("");
        txtU4Contraseña.setText("");
        cmbU4TipoUsuario.setSelectedItem(null);
        metJTableVerUsuarios(tblU4AdminAjuste);
    }//GEN-LAST:event_btbU4LimpiarMouseClicked

    private void btbU4LimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btbU4LimpiarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btbU4LimpiarActionPerformed
    ...
    private javax.swing.JButton btbU4Limpiar;
    private javax.swing.JButton btnU4Modificar;
    private javax.swing.JButton btnU4Regresar;
    ...
    public static javax.swing.JLabel txt_u4_admin_ajuste_nombre_vigilante;
