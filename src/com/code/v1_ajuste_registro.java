 ...
 * @author luise
 */
public final class v1_ajuste_registro extends javax.swing.JFrame {
 ...
 /* ------------------------------------------- Ini Validador (Cantidad Caracteres) -------------------------------------------- */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v1_ajuste_registro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v1_ajuste_registro().setVisible(true);
            }
        });
    }
