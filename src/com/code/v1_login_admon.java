...
import static com.code.v1_login_admon_ajustes.v1_login_admon_ajuste_name_vigilante;
import static com.code.v1_ajuste_registro.v1_ajuste_registro_name_vigilante;

/**
 *
 * @author luise
 */
public class v1_login_admon extends javax.swing.JFrame {
...
//--------------------------------------------------------------------------------------------------------|
    ...
    private void metSetV1Ajuste() {
        v1_login_admon_ajustes HALOID = new v1_login_admon_ajustes();// Creamos una nueva instancia de la vista v1_adm_login  
...
//--------------------------------------------------------------------------------------------------------|
    ...
    private void metSetV1Login() {
        v1_login HALOID = new v1_login();// Creamos una nueva instancia de la vista v1_adm_login  
        HALOID.setVisible(true);   // Hacemos visible la nueva vista
        this.dispose(); // Cerramos la vista actual
    }
//--------------------------------------------------------------------------------------------------------|
 ...
 /* ----------------------------------------------- Ini Validador (Cantidad Caracteres)  ----------------------------------------------- */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v1_login_admon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new v1_login_admon().setVisible(true);
        });
    }
